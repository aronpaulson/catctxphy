...
%\nocite{53fd7d7e}
%TODO
%  creation/reflection of limits/colimits
...
\begin{align*}
  ...
  P(J)
\end{align*}
is called \textbf{dependent function (through $P$)}.\footnote{as already mentioned this plays a big role in UFP-HoTT} To define a dependent function we write
\begin{align*}
  f
  :=
  \left(
